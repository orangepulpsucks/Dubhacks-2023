...
*/
export default class GenEventInfo {
  ajv: any;
  openAI: any;
  tessWorker: any;
  today: any;
  ...
  */
  async parseEventFromImage(imagePath: any) {
  ...
  */
  getJson(title: any, summary: any, month: any, day: any, year: any, priority: any) { // Should I just make constructor to initialize the ajv which is used over and over?
    let json =  {
        title: title,
        summary: summary,
